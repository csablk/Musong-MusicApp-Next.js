...
const UploadModal = () => {
    ...
    return ( 
        <Modal title="Add a song" description="Upload and mp3 file" isOpen={uploadModal.isOpen} onChange={onChange}>
            <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-y-4">
                ...
                <Button disabled={isLoading} className="text-white cursor-pointer" type="submit">
                    Create
                </Button>
            </form>
        </Modal>
